...
public class BoardController {
	...
	public String insertReply(final MultipartHttpServletRequest multiRequest,
	...
	/*
	 * AdminLTE용 게시물 삭제(관리자삭제는 테이블 레코드-1줄 을 삭제처리) 기존에는 게시판 레코드-1줄에서 USE_AT필드값을 N으로
	 * 변경해서 처리 와 차이있음.
	 */
	@RequestMapping("/admin/board/deleteBoard.do")
	public String deleteBoard(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("bdMstr") BoardMaster bdMstr,
	...
	public String selectBoard(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		/*
		 * if(boardVO.getBbsId() == "") { boardVO.setBbsId("BBSMSTR_AAAAAAAAAAAA"); }
		 */
